        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsAcceptedByCraftsman = table.Column<bool>(type: "boolean", nullable: false),
                    IsClosedByCraftsman = table.Column<bool>(type: "boolean", nullable: false),
                    IsClosedByClient = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OfferedServiceId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    OfferedServiceName = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    OfferedServiceDescription = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppUserOfferedService_OfferedServices_OfferedServicesOffere~",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "b9d5c788-2169-4e5b-8d1b-71635b55a0a7", null, "User", "USER" },
                    { "f2ccb779-9308-4b1a-8f36-c57c99170e3e", null, "Admin", "ADMIN" }
                });
